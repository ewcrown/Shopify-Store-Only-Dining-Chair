...
class QuantityInput extends HTMLElement {
  ...
  validateQtyRules() {
    ...
    if (this.input.min) {
      ...
      const buttonMinus = this.querySelector(".quantity__button[name='minus']");
      // console.log(buttonMinus.nextElementSibling)
...
class VariantSelects extends HTMLElement {
  ...
  filterImgVariant(){
    console.log("Thumbnail:", this.currentVariant)
    if (this.currentVariant.featured_media && this.currentVariant.featured_media.alt ) {
      // show only the thumbnail selected color
      console.log("Thumbnail:", this.currentVariant.featured_media.alt )
...
// Header second level menu open on mouse enter
if(window.innerWidth > 989){
  const menuItem = document.querySelectorAll('header-menu > details')
...
// Collapsible Content create by SS
